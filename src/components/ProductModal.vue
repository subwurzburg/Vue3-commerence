          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              ...
              <div class="mb-3">
                ...
                laceholder="請輸入產品說明內容" v-model="tempProduct.content"></textarea>
              </div>
              <div class="mb-3">
...
<script>
import MixinModal from '../assets/mixins/MixinModal'
...
export default {
  ...
  methods: {
    updatePicture () {
      const picFile = this.$refs.pictureInput.files[0]
      const formData = new FormData()
      formData.append('file-to-upload', picFile)
